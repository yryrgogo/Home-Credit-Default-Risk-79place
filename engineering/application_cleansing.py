...
def feature_contraction(data):
    ...
    data.to_csv('../data/application_train_test.csv', index=False)
    sys.exit()
...
def main():
    ...
    nan_list = ['DAYS_LAST_PHONE_CHANGE']
    ...
    ' CODE_GENDERのXNAをFへ '
    #  a = np.load('../features/3_winner/CODE_GENDER.npy')
    #  a = np.where(a=='XNA', 'F', a)
    #  np.save('../features/3_winner/CODE_GENDER.npy', a)
